    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="zhiyuanzheShenqingUuidNumber">
                       <el-input v-model="ruleForm.zhiyuanzheShenqingUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.zhiyuanzheShenqingUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="zhiyuanzheShenqingUuidNumber">
                           <el-input v-model="ruleForm.zhiyuanzheShenqingUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="理由" prop="zhiyuanzheShenqingText">
                        <el-input type="textarea"  :readonly="ro.zhiyuanzheShenqingText" v-model="ruleForm.zhiyuanzheShenqingText" placeholder="理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.zhiyuanzheShenqingText" label="理由" prop="zhiyuanzheShenqingText">
                            <span v-html="ruleForm.zhiyuanzheShenqingText"></span>
                        </el-form-item>
                    </div>
                </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.zhiyuanzheShenqingYesnoTypes" label="报名状态" prop="zhiyuanzheShenqingYesnoTypes">
                        <el-input v-model="ruleForm.zhiyuanzheShenqingYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.zhiyuanzheShenqingYesnoText" label="审核回复" prop="zhiyuanzheShenqingYesnoText">
                        <span v-html="ruleForm.zhiyuanzheShenqingYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.zhiyuanzheShenqingShenheTime" label="审核时间" prop="zhiyuanzheShenqingShenheTime">
                        <span v-html="ruleForm.zhiyuanzheShenqingShenheTime"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    zhiyuanzheShenqingUuidNumber: true,
                    yonghuId: false,
                    zhiyuanzheShenqingText: false,
                    insertTime: false,
                    zhiyuanzheShenqingYesnoTypes: false,
                    zhiyuanzheShenqingYesnoText: false,
                    zhiyuanzheShenqingShenheTime: false,
                },
                ruleForm: {
                    zhiyuanzheShenqingUuidNumber: new Date().getTime(),
                    yonghuId: '',
                    zhiyuanzheShenqingText: '',
                    insertTime: '',
                    zhiyuanzheShenqingYesnoTypes: '',
                    zhiyuanzheShenqingYesnoText: '',
                    zhiyuanzheShenqingShenheTime: '',
                },
                zhiyuanzheShenqingYesnoTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   zhiyuanzheShenqingUuidNumber: [
                   ...
                   insertTime: [
                              { required: true, message: '志愿者申请时间不能为空', trigger: 'blur' },
                          ],
                   zhiyuanzheShenqingYesnoTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhiyuanzhe_shenqing_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zhiyuanzheShenqingYesnoTypesOptions = data.data.list;
                    }
                });
