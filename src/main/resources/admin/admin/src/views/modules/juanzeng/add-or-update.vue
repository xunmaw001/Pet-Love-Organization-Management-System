    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="捐赠" prop="juanzengText">
                        <el-input type="textarea"  :readonly="ro.juanzengText" v-model="ruleForm.juanzengText" placeholder="捐赠"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.juanzengText" label="捐赠" prop="juanzengText">
                            <span v-html="ruleForm.juanzengText"></span>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="金额" prop="newMoney">
                       <el-input v-model="ruleForm.newMoney"
                                 placeholder="金额" clearable  :readonly="ro.newMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="金额" prop="newMoney">
                           <el-input v-model="ruleForm.newMoney"
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   juanzengText: [
                              { required: true, message: '捐赠不能为空', trigger: 'blur' },
                          ],
                   newMoney: [
