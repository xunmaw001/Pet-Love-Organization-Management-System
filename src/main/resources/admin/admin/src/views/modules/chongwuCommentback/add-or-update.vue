    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="评价内容" prop="chongwuCommentbackText">
                        <el-input type="textarea"  :readonly="ro.chongwuCommentbackText" v-model="ruleForm.chongwuCommentbackText" placeholder="评价内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chongwuCommentbackText" label="评价内容" prop="chongwuCommentbackText">
                            <span v-html="ruleForm.chongwuCommentbackText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                ...
                this.ro.chongwuCommentbackText = true;//评价内容
            }else{
            }
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `chongwuCommentback/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`chongwuCommentback/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chongwuCommentbackCrossAddOrUpdateFlag = false;
                                        this.parent.search();
