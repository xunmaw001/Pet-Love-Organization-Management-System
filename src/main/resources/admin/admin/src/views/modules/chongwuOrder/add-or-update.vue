    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="chongwuOrderTypes">
                        <el-select v-model="ruleForm.chongwuOrderTypes" :disabled="ro.chongwuOrderTypes" placeholder="请选择订单类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="订单类型" prop="chongwuOrderValue">
