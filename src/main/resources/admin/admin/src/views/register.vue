    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">宠物爱心组织管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        -->
                        <!--
                            <el-form-item label="用户类型" class="input" v-if="tableName=='yonghu'">
                                <el-input v-model="ruleForm.yonghuTypes" autocomplete="off" placeholder="用户类型"  />
                           </el-form-item>
                        -->
                        <!--
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/chongwuaixinzuzhiguanli/img/back-img-bg.jpg);
