...
var centerMenu = [
    ...
    ,{
        name: '流浪收藏',
        url: '../liulangCollection/list.html'
    }
    ,{
        name: '流浪订单',
        url: '../liulangOrder/list.html'
    }
    ,{
        name: '团队活动收藏',
        url: '../tuanduiCollection/list.html'
    }
    ,{
        name: '团队活动报名',
        url: '../tuanduiOrder/list.html'
    }
    ,{
        name: '志愿者申请',
        url: '../zhiyuanzheShenqing/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/chongwuaixinzuzhiguanli/admin/dist/index.html#/login";
