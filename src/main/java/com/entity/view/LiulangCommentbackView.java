...
public class LiulangCommentbackView extends LiulangCommentbackEntity implements Serializable {
	...
	public LiulangCommentbackView() {

	}

	public LiulangCommentbackView(LiulangCommentbackEntity liulangCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, liulangCommentbackEntity);
