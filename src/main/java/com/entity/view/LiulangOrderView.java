...
public class LiulangOrderView extends LiulangOrderEntity implements Serializable {
	...
	*/
	...
	private String liulangOrderValue;
	...
	public LiulangOrderView() {

	}

	public LiulangOrderView(LiulangOrderEntity liulangOrderEntity) {
		try {
			BeanUtils.copyProperties(this, liulangOrderEntity);
	...
	* 获取： 订单类型的值
	*/
	public String getLiulangOrderValue() {
		return liulangOrderValue;
	}
	/**
	* 设置： 订单类型的值
	*/
	public void setLiulangOrderValue(String liulangOrderValue) {
		this.liulangOrderValue = liulangOrderValue;
	}
	...
	public String toString() {
		return "LiulangOrderView{" +
			", liulangOrderValue=" + liulangOrderValue +
