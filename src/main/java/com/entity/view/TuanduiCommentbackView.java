...
public class TuanduiCommentbackView extends TuanduiCommentbackEntity implements Serializable {
	...
	public TuanduiCommentbackView() {

	}

	public TuanduiCommentbackView(TuanduiCommentbackEntity tuanduiCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, tuanduiCommentbackEntity);
