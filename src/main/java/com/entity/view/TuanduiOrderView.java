...
public class TuanduiOrderView extends TuanduiOrderEntity implements Serializable {
	...
	*/
	...
	private String tuanduiOrderValue;
	...
	public TuanduiOrderView() {

	}

	public TuanduiOrderView(TuanduiOrderEntity tuanduiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, tuanduiOrderEntity);
	...
	* 获取： 订单类型的值
	*/
	public String getTuanduiOrderValue() {
		return tuanduiOrderValue;
	}
	/**
	* 设置： 订单类型的值
	*/
	public void setTuanduiOrderValue(String tuanduiOrderValue) {
		this.tuanduiOrderValue = tuanduiOrderValue;
	}
	...
	public String toString() {
		return "TuanduiOrderView{" +
			", tuanduiOrderValue=" + tuanduiOrderValue +
