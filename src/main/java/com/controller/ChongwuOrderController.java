...
//                            chongwuOrderEntity.setChongwuOrderTypes(Integer.valueOf(data.get(0)));   //订单类型 要改的
...
//            double balance = yonghuEntity.getNewMoney() - chongwuEntity.getChongwuNewMoney()*1;//余额
//            if(balance<0)
//                return R.error(511,"余额不够支付");
            chongwuOrder.setChongwuOrderTypes(101); //设置订单状态为已申请认养
//            chongwuOrder.setChongwuOrderTruePrice(chongwuEntity.getChongwuNewMoney()*1); //设置实付价格
...
//            YonghuEntity yonghuEntity = yonghuService.selectById(chongwuEntity.getYonghuId());
//            yonghuEntity.setNewMoney(yonghuEntity.getNewMoney()+chongwuOrder.getChongwuOrderTruePrice());//动态计算金额
            yonghuService.updateById(yonghuEntity);
    ...
    public R refund(Integer id, HttpServletRequest request){
        ...
        String role = String.valueOf(request.getSession().getAttribute("role"));
            ...
            Double zhekou = 1.0;
                ...
                //计算金额
//                Double money = chongwuEntity.getChongwuNewMoney() * buyNumber  * zhekou;
                //计算所获得积分
                Double buyJifen = 0.0;
//                yonghuEntity.setNewMoney(yonghuEntity.getNewMoney() + money); //设置金额
            ...
            chongwuOrderService.updateAllColumnById(chongwuOrder);//根据id更新
    ...
    */
    ...
    public R commentback(Integer id, String commentbackText, Integer chongwuCommentbackPingfenNumber, HttpServletRequest request){
        ...
        ChongwuCommentbackEntity chongwuCommentbackEntity = new ChongwuCommentbackEntity();
            chongwuCommentbackEntity.setId(id);
            chongwuCommentbackEntity.setChongwuId(chongwuId);
            chongwuCommentbackEntity.setYonghuId((Integer) request.getSession().getAttribute("userId"));
            chongwuCommentbackEntity.setChongwuCommentbackText(commentbackText);
            chongwuCommentbackEntity.setInsertTime(new Date());
            chongwuCommentbackEntity.setReplyText(null);
            chongwuCommentbackEntity.setUpdateTime(null);
            chongwuCommentbackEntity.setCreateTime(new Date());
            chongwuCommentbackService.insert(chongwuCommentbackEntity);

            chongwuOrder.setChongwuOrderTypes(105);//设置订单状态为已评价
            chongwuOrderService.updateById(chongwuOrder);//根据id更新
            return R.ok();
    }
    ...
    public R deliver(Integer id  , HttpServletRequest request){
        ...
        chongwuOrderEntity.setChongwuOrderTypes(103);//设置订单状态为已同意认养
    ...
    public R receiving(Integer id , HttpServletRequest request){
        logger.debug("refund:,,Controller:{},,ids:{}",this.getClass().getName(),id.toString());
        ChongwuOrderEntity  chongwuOrderEntity = chongwuOrderService.selectById(id);
        chongwuOrderEntity.setChongwuOrderTypes(104);//设置订单状态为认养
        chongwuOrderService.updateById( chongwuOrderEntity);
        return R.ok();
    }
    ...
    public R jujue(Integer id , HttpServletRequest request){
        logger.debug("refund:,,Controller:{},,ids:{}",this.getClass().getName(),id.toString());
        ChongwuOrderEntity  chongwuOrderEntity = chongwuOrderService.selectById(id);
        chongwuOrderEntity.setChongwuOrderTypes(106);//设置订单状态为认养
        chongwuOrderService.updateById( chongwuOrderEntity);
        return R.ok();
    }
